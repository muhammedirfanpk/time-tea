        ...
        <section className=' w-full  bg-[#FFFDF8]'>
            <div className=' flex items-center justify-center py-12 px-4 pt-8'>
                <div className='flex max-w-2xl flex-col items-center gap-3 text-center  '>
                    ...
                    <h1 style={{ fontFamily: "var(--font-body)" }} className='font-lato text-base uppercase tracking-wide text-[#0A0909]'>
                         our story
                    </h1>
                    <p className='font-playfair_display text-[#3F2419] text-2xl  leading-relaxed '>
